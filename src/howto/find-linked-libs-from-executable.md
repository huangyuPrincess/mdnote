...
Use the ldd command followed by the executable name to list dynamic dependencies.
...
Use the dumpbin /dependents command (part of Visual Studio tools) or a graphical tool like Dependency Walker.
